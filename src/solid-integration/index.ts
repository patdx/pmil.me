...
import solid, {
  type Options as ViteSolidPluginOptions,
  ...
  return {
    ...
    optimizeDeps: {
      ...
      exclude: [
        ...
        './src/solid-integration/server.ts',
      ],
    },
    plugins: [
...
function getRenderer(): AstroRenderer {
  return {
    ...
    clientEntrypoint: './src/solid-integration/client.ts',
    serverEntrypoint: './src/solid-integration/server.ts',
